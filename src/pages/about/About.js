...
function About() {
  return (
    <div className="px-12 pt-16 lg:w-1/2 flex flex-col items-start gap-5">
      ...
      <p className="text-neutral-gray">Sunt minim sint aliqua excepteur reprehenderit in dolore laboris. Veniam nisi nisi laborum ex et ad laboris ut aliquip ut incididunt do. Ad est est incididunt nostrud nulla cillum nulla.</p>
